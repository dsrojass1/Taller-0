...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("\n14. ****Modificación 1: País que representa el atleta\n");
	}
	/**
	 * Modificación 1: Informa al usuario el nombre del país al cual representa el atleta ingresado
	 */
	
	private void ejecutarModificacion1()
	{
		String atletaNombre = input("\n" + "Por favor ingrese el nombre de un atleta");
		String nombrePais = calculadora.paisDelAtleta(atletaNombre);
		if (nombrePais.equals("No encontrado"))
		{
			System.out.println("El atleta no fue encontrado en el archivo");
		}
		else
		{
			System.out.println("El país del atleta " + "\'" + atletaNombre + "\'" + " es " + "\'" + nombrePais + "\'");
		}
