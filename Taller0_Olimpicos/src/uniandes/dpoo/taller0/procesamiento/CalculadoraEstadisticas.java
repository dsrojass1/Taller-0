...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Busca el atleta ingresado como parámetro en la lista de atletas atributo y obtiene el nombre del país
	 * del atleta.
	 * 
	 * @param String nombre del atleta
	 * @return String nombre del país al que pertenece el atleta
	 */
	public String paisDelAtleta(String nombreAtleta)
	{
		String nombrePais = "No encontrado";
		for (Atleta i : atletas)
		{
			if (i.darNombre().equals(nombreAtleta))
			{
				Pais pais = i.darPais();
